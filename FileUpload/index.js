    ...
    render() {
        return (
            <div className="mrc-file-upload">
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" height="64" width="48" viewBox="0 0 48 64" className="m-icon blue" style={{"fontSize": "3rem"}}>
                    <g fill="#000" fill-rule="evenodd" stroke="none" transform="translate(-8)">
