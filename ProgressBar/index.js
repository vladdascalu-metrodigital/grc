...
export default class ProgressBar extends Component {
    constructor(props) {
        ...
        this.mappings = {
            ...
            4: {
                fragmentName: 'split-4',
                fragments: ['split-4-first', 'split-4-second', 'split-4-third', 'split-4-forth'],
            },
        };
    }
    ...
    createBar() {
        ...
        return (
            <section className="bar">
                {barFragments.map((bf, idx) => (
                    <div className={`${bf} ${mapping.fragmentName}`} key={idx} />
                ))}
            </section>
        );
    }
