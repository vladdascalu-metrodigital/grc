...
export default class CustomerTrigger extends Component {
    ...
    displayCustomerWarnings() {
        if (
            this.props.isWithWarning != undefined &&
            this.props.isWithWarning != null &&
            this.props.isWithWarning == true
        ) {
                        ...
                        <tr>
                            <td>
                                <div>
                                    ...
                                    {this.asNumberForAvailable(this.props.current, this.props.customer.limitExhaustion, this.props.customer.country)}
                                </div>
                            </td>
                            <td>
                                <div>
    ...
    displayApprovedLimit() {
        if (this.isValidAmount(this.props.approved)) {
            return (
                <div>
                    {' '}
                    {lookup('mrc.creditdetails.applied') + ':'}{' '}
