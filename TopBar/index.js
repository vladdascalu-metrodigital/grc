...
class TopBarLayout extends Component {
    render() {
        if (this.props.tablet && this.props.title !== 'Launch Pad') return null;
        //<QuickNav active={this.props.active} config={this.props.config}/>;
        else if (this.props.tablet) return null;
        else return <BrandBar title={this.props.title} />;
    }
}
